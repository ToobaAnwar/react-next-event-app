...
async function getStaticProps() {
    ...
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://toobaanwar:tooba2829@cluster0.svrdt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0");
    const db = client.db();
